...
TEST(MultTest, MultDouble) {
	Base* left = new Op(10.5);
	Base* right = new Op(5.5);
...
TEST(MultTest, MultDoubleAddString) {
	Base* addOne = new Op(10.5);
        Base* addTwo = new Op(10.5);
	Base* right = new Op(5.5);
        Base* left = new Add(addOne, addTwo); //10 + 10
	Base* test = new Mult(left, right);
...
TEST(MultTest, MultDoubleNumAdd) {
	Base* addOne = new Op(10.5);
        Base* addTwo = new Op(10.5);
	Base* right = new Op(5.5);
        Base* left = new Add(addOne, addTwo); //10 + 10 = 20  * 5
	Base* test = new Mult(left, right);
...
TEST(MultTest, MultDoubleTwoAddString) {
	Base* addOne = new Op(10.5);
        Base* addTwo = new Op(10.5);
        Base* rightOne = new Op(10.5);
        Base* rightTwo = new Op(10.5);
    	Base* left = new Add(addOne, addTwo); //10 + 10
    	Base* right = new Add(rightOne, rightTwo);
	Base* test = new Mult(left, right);
...
TEST(MultTest,MultDoubleTwoAdd) {
	Base* addOne = new Op(10.5); Op* addTwo = new Op(10.5);
    	Base* rightOne = new Op(10.5); Op* rightTwo = new Op(10.5);
    	Base* left = new Add(addOne, addTwo); Add* right = new Add(rightOne, rightTwo);
	Base* test = new Mult(left, right);
